...
# make sibling packages visible when running as week2/test/test.py
# at very top of test.py, above other imports

from python import sys as pysys            # use CPython sys via Codon interop
pysys.path[:0] = ["..", "../code"]         # prepend parent dirs for 'trviz'
